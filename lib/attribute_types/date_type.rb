class DateType
  ...
  def editable (property, value)
    button_up = "<td><a href='#' onclick='move_up(this)' class='btn btn-info move up'><span class='glyphicon glyphicon-arrow-up'></span></a></td>"
		...
		field_type = "<div class='col-md-8'><input name='#{property}' type='date' value='#{value}' class='form-control input-md'/></div>"
		field_hidden ="<input type='hidden' name='#{property + '_type'}' value='date'>"

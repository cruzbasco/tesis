class NumericType
  ...
  def editable (property, value)
    "<div class='form-group'><label class='control-label col-sm-2' for='#{property}'>#{property}:</label><div class='col-md-8'><input name='#{property}' type='number' value='#{value}' class='form-control input-md' required=''/></div></div>"
  end
